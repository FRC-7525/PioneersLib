...
import static org.team7525.autoAlign.OldRepulsorFieldPlannerConstants.*;
...
public class OldRepulsorFieldPlanner {
	 ...
	 */
	public OldRepulsorFieldPlanner(List<Obstacle> fieldObstacles, List<Obstacle> walls, boolean simulateArrows) {
